...
def feature_target_preparation(train_df, train_df_encoded, test_df, test_df_encoded):
    ...
    y_train_encoded = to_categorical(train_df_encoded['subtask_c'], 2)
    y_test_encoded = to_categorical(test_df_encoded['subtask_c'], 2)

    y_train_mapped = train_df_encoded['subtask_c'].copy()
    y_test_mapped = test_df_encoded['subtask_c'].copy()
